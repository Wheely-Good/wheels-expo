export type LessonStep =
  ...
  | { type: 'example'; sentence: string; translation: string }
  | { type: 'quiz'; question: string; sentence: string; options: string[]; correctAnswer: string }
  | { type: 'build'; sentence: string; options: string[]; correctAnswer: string }
  | { type: 'listen'; sentence: string; translation: string }
  | { type: 'finish' };
